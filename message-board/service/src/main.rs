...
impl MessageBoard {
    ...
    pub fn new(ctx: &Context, bcast_char_limit: Option<u32>) -> Self {
...
impl MessageBoard {
    ...
    pub fn fetch_inbox(&mut self, ctx: &Context) -> Vec<Message> {
        self.accounts
            .get_mut(&ctx.sender())
...
mod tests {
    ...
    fn post_nolimit() {
        ...
        let mut mb = MessageBoard::new(&actx, None);
    ...
    fn post_limit() {
        let (_admin, actx) = create_account();
        let mut mb = MessageBoard::new(&actx, Some(1));
    ...
    fn posts() {
        ...
        let mut mb = MessageBoard::new(&actx, Some(140));
    ...
    fn dm() {
        ...
        let mut mb = MessageBoard::new(&kctx, Some(140));
        ...
        assert_eq!(mb.fetch_inbox(&kctx), Vec::new());
